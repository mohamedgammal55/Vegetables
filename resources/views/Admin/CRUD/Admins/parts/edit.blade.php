<!--begin::Form-->
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('admins.update',$find->id)}}">
@csrf
    @method('PUT')
<!--begin::Input group-->
    <div class="d-flex flex-column mb-7 fv-row">
        ...
        <!--end::Label-->
        <input type="text" class="form-control form-control-solid" placeholder="الإسم" name="name" value="{{$find->name}}" />
    </div>
    <!--end::Input group-->
    ...
    <div class="d-flex flex-column mb-7 fv-row">
        ...
        <!--end::Label-->
        <input type="text" class="form-control form-control-solid" placeholder="اسم المستخدم" name="user_name" value="{{$find->user_name}}" />
    </div>
    <!--end::Input group-->
