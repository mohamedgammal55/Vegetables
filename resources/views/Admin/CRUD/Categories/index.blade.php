    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الفئات
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">الفئات</span>
                            </h3>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="table"
                                    ...
                                    <tr class="fw-bolder text-muted">
                                        <th class="min-w-150px">عربي</th>
                                        <th class="min-w-150px">إنجليزي</th>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '#addBtn', function () {
            ...
            setTimeout(function (){
                $('#form-load').load("{{route('categories.create')}}")
            },1000)
