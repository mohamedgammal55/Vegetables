...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('products.store')}}">
    ...
    <div class="d-flex flex-column mb-7 fv-row">
        ...
        <!--end::Label-->
        <input type="text" class="form-control form-control-solid" placeholder="عربي" name="title_ar" value="" />
    </div>
    <!--end::Input group-->
    ...
    <div class="d-flex flex-column mb-7 fv-row">
        ...
        <!--end::Label-->
        <input type="text" class="form-control form-control-solid" placeholder="إنجليزي" name="title_en" value="" />
    </div>
    <!--end::Input group-->
    ...
    <div class="d-flex flex-column mb-7 fv-row">
        ...
        <select name="category_id" class="form-control">
            ...
            {!! myForEach($categories,'id','title_ar') !!}
        </select>
    </div>
    <!--end::Input group-->
